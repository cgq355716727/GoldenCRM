...
CREATE TABLE `t_repare_order_item` (
  `id` int(11) NOT NULL COMMENT '主键',
  `amount` int(11) DEFAULT NULL COMMENT '保留字段',
  `repare_order_id` int(11) DEFAULT NULL COMMENT '订单id',
  `repare_detail` varchar(255) DEFAULT NULL COMMENT '特殊要求',
  `comment` varchar(255) DEFAULT NULL COMMENT '保留字段',
  PRIMARY KEY (`id`)
